...
ren "ManipuladorBaseMovel2.png" "image1.png
...
ffmpeg -f concat -safe 0 -i files.txt -vf "fps=10,pad=696:564:(ow-iw)/2:(oh-ih)/2" -loop 0 C:\Users\Escritorio2\Downloads\yoguys.gif
del image1.png
del palette.png
del image2.png
del palette.png
del image3.png
del palette.png
explorer C:\Users\Escritorio2\Downloads\yoguys.gif
